...
Result after 5000 iterations with no converge: Func Val=141.234729; FONC Residual=0.145495; Sqr Diff=0.000007\\
When leave the algorithm to run until it converges, it stopped after 8931 iterations, results are followed:\\
Func Val=141.231578; FONC Residual=0.017225; Sqr Diff=0.000004\\
\end{enumerate}
